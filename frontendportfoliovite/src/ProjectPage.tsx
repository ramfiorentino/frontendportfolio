...
function ProjectPage() {
  ...
  useEffect(() => {
    if (slug) {
      fetchProjectById(slug).then((data) => setProject(data));
    }
  }, [slug]);
  ...
  return (
    <div>
      ...
      <div className="mt-5 px-2 pb-5 border-b-2 border-primary text-right md:px-9 md:flex md:items-center md:justify-between">
          ...
          <div id="key-features">
            {project.keyFeatures.map((feature, index) => (
              <div key={index} className="key-feature mx-2 my-5 md:flex md:flex-col md:items-center">
                ...
                <div className="mt-5 border-2 border-primary md:w-2/3">
